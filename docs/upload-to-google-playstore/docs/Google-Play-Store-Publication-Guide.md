...
This guide is based on the **z-control Translator app** publication process and reused here as a template for apps created from this setup app. 

The setup app is used for creating new apps that will be deployed on Google Play and will follow a similar publication workflow, but with its own specific details and assets.
